...
class WineVintagesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create wine_vintage" do
    assert_difference("WineVintage.count") do
      post wine_vintages_url, params: { wine_vintage: { alcohol: @wine_vintage.alcohol, likes: @wine_vintage.likes, vintage: @wine_vintage.vintage, wine_id: @wine_vintage.wine_id } }
    end
  ...
  test "should update wine_vintage" do
    patch wine_vintage_url(@wine_vintage), params: { wine_vintage: { alcohol: @wine_vintage.alcohol, likes: @wine_vintage.likes, vintage: @wine_vintage.vintage, wine_id: @wine_vintage.wine_id } }
